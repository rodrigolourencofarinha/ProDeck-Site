...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="bg-background pt-20 pb-10 transition-colors">
      <div className="container mx-auto flex max-w-4xl flex-col items-center gap-6 px-4 text-center">
        <img src={logo} alt="ProDeck Logo" className="mx-auto mb-2 h-20 w-auto dark:invert" />
      ...
      <div className="mt-10 w-full px-4">
        <img
          ...
          className="w-full h-auto rounded-lg border bg-muted p-2 shadow-lg transition-colors"
        />
      </div>
    </section>
  );
