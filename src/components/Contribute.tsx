      ...
      <div className="container mx-auto px-4 max-w-4xl grid gap-8 md:grid-cols-2">
        ...
        <div>
          ...
          <p className="text-muted-foreground mb-4">
            ProDeck is open-source! You’re welcome to submit issues, report
            bugs, or suggest features via the GitHub repository.
          </p>
          <a
            ...
            className="inline-flex items-center justify-center whitespace-nowrap rounded-md 
                       ...
                       disabled:opacity-50 border border-input bg-background shadow-sm 
        ...
        <div>
          ...
          <ul className="list-disc pl-5 text-muted-foreground space-y-1">
            ...
            <li>
              Use the{" "}
              <a
                href="https://github.com/fernandreu/office-ribbonx-editor"
                target="_blank"
                rel="noreferrer"
                className="font-medium underline underline-offset-4"
              >
